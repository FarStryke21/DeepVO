...
class Parameters():
    def __init__(self):
        ...
        self.data_dir = 'C:/Users/amanc/OneDrive/Desktop/787 Project/DeepVO-main/dataset'
        self.image_dir = self.data_dir + '/sequences/'
        self.pose_dir = self.data_dir + '/poses/'
        
        # List of train paths, valid paths and test paths
        self.train_video = ['01'] #, '02', '08', '09']
        self.valid_video = ['01']#['03', '05']
        self.test_video = ['01']#['03', '04', '05', '06', '07', '10']
