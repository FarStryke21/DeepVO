...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_dir', type=str, default=f'{par.save_path}/results', help='Directory path of storing the odometry results')
    #CHANGELOG: 00_PRED REMOVED
    parser.add_argument('--eva_seqs',   type=str, default='01_pred', help='The sequences to be evaluated') 
